...
//   // Only connect to WebSocket when component is mounted
//   const wsUrl = `ws://${window.location.hostname}:8000/ws/signals`;
//   const { data, isConnected, error, reconnect } = useWebSocket<SignalData>(wsUrl);
